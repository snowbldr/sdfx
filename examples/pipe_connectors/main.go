...
func main() {
	...
	render.ToSTL(s, "pipe_connector_2a.stl", render.NewMarchingCubesOctreeParallel(300))
	...
	render.ToSTL(s, "pipe_connector_2b.stl", render.NewMarchingCubesOctreeParallel(300))
	...
	render.ToSTL(s, "pipe_connector_3a.stl", render.NewMarchingCubesOctreeParallel(300))
	...
	render.ToSTL(s, "pipe_connector_3b.stl", render.NewMarchingCubesOctreeParallel(300))
	...
	render.ToSTL(s, "pipe_connector_4a.stl", render.NewMarchingCubesOctreeParallel(300))
	...
	render.ToSTL(s, "pipe_connector_4b.stl", render.NewMarchingCubesOctreeParallel(300))
	...
	render.ToSTL(s, "pipe_connector_5a.stl", render.NewMarchingCubesOctreeParallel(300))
