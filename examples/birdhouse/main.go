...
git@github.com:snowbldr/sdfx.git
https://github.com/snowbldr/sdfx/tree/master/examples/birdhouse
...
func main() {
	...
	render.ToSTL(s, "birdhouse.stl", render.NewMarchingCubesOctreeParallel(300))
}
